...
if __name__ == "__main__":
    ...
    height: int = 1145
    client = VizImage()
    unobfuscated_image: Image = client.unobfuscate_image(
        obfuscated_image_name, width, height
    )
